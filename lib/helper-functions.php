 ...
 * GC Twenty.
 *
 * This file adds the required helper functions used in the GC Twenty Theme.
 *
 * @package GC Twenty
 * @author  StudioPress
 ...
 */
function gc_twenty_color_contrast( $color ) {
 ...
 */
function gc_twenty_color_brightness( $color, $change ) {
